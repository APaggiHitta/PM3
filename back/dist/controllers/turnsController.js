    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, turnsService_1.getTurnsByIdService)(turnId)];
            case 1:
                turn = _a.sent();
                if (!turn) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, turnsService_1.getTurnsByUserIdService)(userId)];
            case 1:
                turns = _a.sent();
                if (!turns) {
                    res.status(404).json({ message: "Turn not found" });
...
var createTurnController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, turnsService_1.createTurnService)(req.body)];
            case 1:
                newTurn = _a.sent();
                res.status(201).json({
